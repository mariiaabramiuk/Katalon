...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'this is demo comment')
...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/p_Go to Homepage'))
